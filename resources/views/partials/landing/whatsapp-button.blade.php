...
>
    ...
    {{-- Tombol bulat --}}
    <span class="relative flex items-center justify-center w-14 h-14 rounded-full bg-forest text-ivory shadow-lg transition-transform duration-300 group-hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold">
        {{-- Ping animation, subtle --}}
        <span class="absolute inset-0 rounded-full bg-forest animate-ping opacity-20"></span>

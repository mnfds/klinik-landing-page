...
>
    ...
    {{-- Tombol bulat --}}
    <span class="relative flex items-center justify-center w-12 h-12 rounded-tl-[15px] rounded-ee-[15px] bg-[#1fb456] text-ivory shadow-lg transition-transform duration-300 group-hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold">
        {{-- Ping animation, subtle --}}
        <span class="absolute inset-0 rounded-tl-[15px] rounded-ee-[15px] bg-[#1fb456] animate-ping opacity-20"></span>

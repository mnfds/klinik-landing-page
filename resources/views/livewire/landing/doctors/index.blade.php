    ...
    <section class="bg-ivory py-16 lg:py-20">
        <div class="max-w-5xl mx-auto px-6 lg:px-8 space-y-8">
            @forelse ($this->doctorsList as $doctor)
                <div wire:key="doctor-{{ $doctor->id }}" class="rounded-tl-[50px] rounded-ee-[50px] border border-forest/10 bg-white overflow-hidden lg:flex">

                    {{-- Photo --}}
                    <div class="lg:w-64 shrink-0 aspect-[4/3] lg:aspect-auto bg-gradient-to-br from-blush/50 via-blush/20 to-ivory flex items-center justify-center overflow-hidden">
                        @if ($doctor->photo)
                            <img
                    ...
                    <div class="p-6 lg:p-8 flex-1">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex flex-wrap gap-2">
                                @forelse ($this->sortedSchedules($doctor->schedules) as $schedule)
                                ...
                                @empty
                                    <span class="text-sm text-charcoal/40">Jadwal belum tersedia.</span>
                                @endforelse
                            </div>
                        </div>

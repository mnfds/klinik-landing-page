<div>
    ...
    <div class="bg-ivory border-b border-forest/10">
        <div class="max-w-5xl mx-auto px-6 lg:px-8 py-4">
            <a href="{{ route('testimonials') }}" wire:navigate class="text-sm text-charcoal/60 hover:text-forest transition-colors inline-flex items-center gap-1">
        ...
        <div class="max-w-5xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="https://wa.me/6285822810149?text={{ urlencode('Halo, saya ingin booking layanan ' . $testimonials['name']) }}"
                        target="_blank"
                        rel="noopener"

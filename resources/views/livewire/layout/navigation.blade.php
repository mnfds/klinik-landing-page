            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}" wire:navigate>
                        <img src="{{ asset('images/logo-no-text.png') }}" alt="{{ config('app.name', 'Klinik') }}" class="block h-9 w-auto fill-current text-gray-800">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.services.index')" :active="request()->routeIs('admin.services.index')" wire:navigate>
                        {{ __('Layanan') }}
                    </x-nav-link>

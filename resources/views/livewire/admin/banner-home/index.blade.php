<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-7">
        <div>
            <h1 class="font-fraunces text-2xl text-forest">Kelola Banner Home</h1>
            <p class="text-sm text-charcoal/60 mt-0.5">Kelola banner yang tampil di halaman beranda.</p>
        </div>
        <button
            type="button"
            wire:click="$dispatch('open-create-banner-home-modal')"
    ...
    {{-- ================= DESKTOP: Tabel ================= --}}
    <div class="hidden md:block bg-white p-2 rounded-2xl shadow-sm overflow-hidden relative">
            ...
            <table class="w-full text-sm">
                <thead class="bg-ivory/70 text-charcoal/60 text-left uppercase text-[11px] tracking-wider">
                    <tr>
                        ...
                        <th class="px-5 py-3.5 font-semibold">Badge</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse ($banners as $banner)
                        <tr wire:key="banner-home-{{ $banner->id }}" class="hover:bg-ivory/40 transition-colors group">
                            ...
                            <td class="px-5 py-3.5 text-xs text-charcoal/70">{{ $banner->text_badge ?? '—' }}</td>
                            <td class="px-5 py-3.5">
                                <button
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-end gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                                    <button
                                        wire:click="$dispatch('open-edit-banner-home-modal', { id: {{ $banner->id }} })"
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-16 text-center text-charcoal/50">
                                <div class="flex flex-col items-center gap-2.5">
                                    ...
                                    <p class="text-sm">Belum ada banner home.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <div class="md:hidden space-y-3">
        @forelse ($banners as $banner)
            <div wire:key="mobile-banner-home-{{ $banner->id }}" class="bg-white rounded-2xl p-4 shadow-sm">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-charcoal/60 mt-1.5">{{ $banner->text_badge ?? '—' }}</p>
                    </div>
                </div>
    ...
    <livewire:admin.banner-home.create />
    <livewire:admin.banner-home.edit />
</div>
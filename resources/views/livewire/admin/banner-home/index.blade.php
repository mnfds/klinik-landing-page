<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-charcoal/60">Kelola banner yang tampil di halaman beranda.</p>
        </div>
        <button
            type="button"
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($banners as $banner)
                    <tr wire:key="banner-home-{{ $banner->id }}">
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 text-xs text-charcoal/70">{{ $banner->text_badge ?? '-' }}</td>
                        <td class="px-4 py-3">
                            <button

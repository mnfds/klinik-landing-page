        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" wire:click.self="closeModal">
            <div class="bg-white rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-fraunces text-lg text-forest">Edit Banner Page</h3>
                ...
                <form wire:submit="save" class="space-y-4">
                    <div>
                        ...
                        <select wire:model="type" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="text_badge" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm">
                    ...
                    <div>
                        ...
                        <textarea wire:model="text_title" rows="2" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm"></textarea>
                    ...
                    <div>
                        ...
                        <textarea wire:model="text_description" rows="3" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm"></textarea>
                    ...
                    <div>
                        ...
                        @if ($existingImageMobile && ! $image_mobile)
                            <img src="{{ \Storage::url($existingImageMobile) }}" class="w-24 h-16 object-cover rounded-lg mb-2">
                        @endif
                    ...
                    <div>
                        ...
                        @if ($existingImageDesktop && ! $image_desktop)
                            <img src="{{ \Storage::url($existingImageDesktop) }}" class="w-32 h-16 object-cover rounded-lg mb-2">
                        @endif

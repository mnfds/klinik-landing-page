        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" wire:click.self="closeModal">
            <div class="bg-white rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-fraunces text-lg text-forest">Tambah Testimoni</h3>
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select wire:model.live="category" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm">
                        ...
                        <div>
                            ...
                            <select wire:model="selected_item" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm" @disabled(! $category)>
                    ...
                    <div>
                        ...
                        <textarea wire:model="message" rows="3" class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm"></textarea>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="youtube_link" placeholder="https://youtube.com/..." class="w-full rounded-lg border-gray-300 focus:border-forest focus:ring-forest text-sm">

        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" wire:click.self="closeModal">
            <div class="bg-white rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-fraunces text-lg text-forest">Edit Layanan</h3>
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div>
                        ...
                        @if ($existingImage && ! $image)
                            <img src="{{ \Storage::url($existingImage) }}" class="w-20 h-20 object-cover rounded-lg mb-2">
                        @endif
                    ...
                    <div>
                        <label class="block text-sm font-medium text-charcoal mb-1">Link YouTube</label>
